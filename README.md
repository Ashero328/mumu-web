...
93 款靜態公版供客戶挑款，跟 `cards/` 那些「會動的網頁卡」是兩件事：
...
| | 用途 |
|---|---|
| `EY8012` | **公版款號**，靜態設計，客戶挑款用（`EY8`＝羊年、`ENY`＝西元新年、`EY0`＝通用農曆年，中間插 `H` 是直式） |
...
出了新款 → 把圖放進 `thumb/` 與 `full/` → 把該節日的數字加上去，就上架了。
